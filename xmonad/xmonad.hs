...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["mpv","Arandr", "Arcolinux-calamares-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "Xfce4-terminal"] -- "Arcolinux-tweak-tool.py", "mpv"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_Escape), spawn $ "arcolinux-logout" ) -- xkill
  ...
  , ((0, xK_Print), spawn $ "flameshot") -- scrot 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'
